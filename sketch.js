...
function draw() {
  ...
  text("If grapes approach the monkey , wait to feed him grapes", 30, 50)
  text("If bananas approach the monkey , wait to feed him bananas", 30, 80)
